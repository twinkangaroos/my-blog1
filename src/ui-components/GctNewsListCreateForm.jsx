...
export default function GctNewsListCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGct_news_id(initialValues.gct_news_id);
    setErrors({});
  };
  const validations = {
    content: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new GctNewsList(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "GctNewsListCreateForm")}
      {...rest}
    >
      <TextField
        label="Content"
